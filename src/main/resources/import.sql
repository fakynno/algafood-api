...
insert into restaurante (nome, taxa_frete, cozinha_id) values ('Take Thai Cozinha', 0, 1);
insert into restaurante (nome, taxa_frete, cozinha_id) values ('Indian food', 0, 2);
