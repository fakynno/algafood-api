...
insert into restaurante (nome, taxa_frete, cozinha_id) values ('Take Thai Cozinha', 5, 1);
insert into restaurante (nome, taxa_frete, cozinha_id) values ('Indian food', 6, 2);
insert into restaurante (nome, taxa_frete, cozinha_id) values ('Rekanto da Feijuca', 8, 3);
insert into restaurante (nome, taxa_frete, cozinha_id) values ('BOJF - Best of Junk Food', 6, 4);
